...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Example:
            netcat.py -t 192.168.110.34 -p 5555 -l -c                       # command shell
            netcat.py -t 192.168.110.34 -p 5555 -l -u=test.txt              # upload to file
            netcat.py -t 192.168.110.34 -p 5555 -l -e=\"cat /etc/passwd\"   # execute command
